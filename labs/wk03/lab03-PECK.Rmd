...
import::here("build_year",
             ...
             .character_only = TRUE)
#this works when I knit, but I get an error when I use it for just running the code.

#import::here("../../analysis/utilities.R")
# this works when I run the code, but not when I knit.
```
...
*To be honest, I don't even know where to start on this. I'm not sure how to find tracts that gentrified or are candidates for gentrification and will most likely schedule an meeting with you to discuss.*