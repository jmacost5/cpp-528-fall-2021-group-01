...
import::here("build_year",
           ...
           # where all these R objects are created
             .from = here::here("analysis/utilities_amp.R"),
             .character_only = TRUE)
```
...
sf.ca$gentrified <- sf.ca$pct.change.full > 100


tm_shape( sf.ca, bbox=bb ) + 
  tm_polygons( col="gentrified", style="cat", title = "MHV Change > 100%", palette=get_brewer_pal(palette="Blues", n = 2, plot=FALSE) ) +
  tm_layout( "Dorling Cartogram", title.position=c("right","top") )
```
