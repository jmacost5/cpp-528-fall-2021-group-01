...
pct.change.rank <- ntile(pct.change.full, 15)
...
likelihood_of_gentrification <- cut(pct.change.rank, 15)
my_colors <- my_colors[pct.change.rank]
 
# Make the plot
plot(sf.ca, col=my_colors)

legend(x = "topright",          # Position
       legend = pct.change.rank,  # Legend texts
       fill = sort(my_colors))     
###

  
#ggplot() +
#  geom_polygon(data = sf.ca, aes( x = long, y = lat, group = group), fill="white", color="grey") +
#  theme_void() +
#  coord_map()
