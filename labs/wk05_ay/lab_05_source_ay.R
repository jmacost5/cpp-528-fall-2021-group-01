...
treat <- as.numeric( d$num.lihtc > 0 )
...
# LIHTC Funding Program for the year 2000

# Check to see if a tract received LIHTC Funding
treat2 <- as.numeric(d$num.lihtc > 0 )

# store the year 2000 data
d4 <- data.frame(y=y1, treat2=treat2, post2=0)

# store the year 2010 data
d5 <- data.frame(y=y2, treat2=treat2, post2=1)
